...
# test the table_generator.rb program using the student program.
...
# A class that models a table generator test using real values.
class TableGeneratorTest < Minitest::Test

  # Here we set up all the values we are going to use.
  def setup
    @headerEmpty = []
    @dataEmpty = []
  ...
  # We test the first text format that is CSV.
  ...
  # We test the second text format that is HTML.
  ...
  # We test the third text format that is Ascii Doc.
